...
export default function AddFilme(){
    ...
    return (
        <>  {/*é dado um input que solicita o nome do filme a ser adicionado, esse nome é armazenado na const 'moviename' e ao apertar o botão é chamada a função 'getMovie' que faz a busca na api e armazena seu resultado no array 'movies'*/}
            <div className="flex flex-col items-center gap-4 py-6">
                <input
                    ...
                    className="w-72 px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#b67c6a]"
                />
                <button
                    type="button"
                    onClick={getMovies}
                    className="w-44 bg-blue-400"
                >Pesquisar
                </button>
            </div>
            ...
            <div>
                { showbutton ? (
                    <div>
                        <p>
                        Filme não encontrado no banco de dados, Adicione Manualmente
                    </p>
